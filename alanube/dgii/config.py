...
ITEM_BILLING_INDICATORS = {
    ITEM_BILLING_INDICATOR_0: Decimal('0'),
    ITEM_BILLING_INDICATOR_1: Decimal('18'),
    ITEM_BILLING_INDICATOR_2: Decimal('16'),
    ITEM_BILLING_INDICATOR_3: Decimal('0'),
    ITEM_BILLING_INDICATOR_4: Decimal('0'),
}
...
NCF_E_32_AMOUNT_LIMIT_FOR_BUYER_RNC = Decimal('250000')


NUMBER_DEFAULT_MAX_DIGIT = 18
NUMBER_DEFAULT_DECIMAL_PLACES = 2
NUMBER_DEFAULT_MAX_VALUE = Decimal('9999999999999999.99')
